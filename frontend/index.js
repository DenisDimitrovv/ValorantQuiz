...
function fetchUsers() {
  fetch('http://localhost:3000/')  // Use the full URL to the Express server
      .then(response => {
          if (!response.ok) {
      ...
      .then(data => {
          ...
          // You can process the data here, e.g., display it in your UI
      })
      .catch(error => console.error('Error fetching users:', error));
}

// Call the fetchUsers function when needed, e.g., on page load or a button click
